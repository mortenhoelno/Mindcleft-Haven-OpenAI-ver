...
export default function Game() {
  ...
  useEffect(() => {
    ...
    // --- Bygg terreng + visuell rutenettvisning ---
    const buildTerrain = () => {
      const heights = [];
      ...
      for (let i = 0; i < GRID_RES; i++) {
        for (let j = 0; j < GRID_RES; j++) {
          ...
          // koble punkter horisontalt og vertikalt
          if (j < GRID_RES - 1) {
    ...
    const init = () => {
      ...
      playerBody = new CANNON.Body({
        ...
        position: new CANNON.Vec3(0, 5, 0), // ✅ start litt over bakken
      });
